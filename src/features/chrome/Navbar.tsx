...
import { ease, isLiteMotion, spring } from '@/shared/motion/motion'
import { useScrollSpy, useScrolledPast } from '@/shared/hooks/useScrollSpy'
import { useMagnetic } from '@/shared/motion/pointerFx'
import { playTick } from '@/shared/lib/fx'
import FxToggle from '@/features/chrome/FxToggle'
import { navSections, spyIds } from '@/app/sections'
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <FxToggle className="hidden sm:flex" />
          ...
          >
            ...
            >
              ...
              <motion.li
                ...
                className="mt-3 flex items-center justify-between gap-3 rounded-xl border border-white/[0.07] bg-white/[0.02] px-3 py-2.5"
              >
                <span className="font-mono text-[11px] normal-case tracking-normal text-ink-faint">
                  ambient effects
                </span>
                <FxToggle />
              </motion.li>
