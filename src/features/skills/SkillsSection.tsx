...
import { getTechMeta, readableAccent } from '@/shared/lib/techMeta'
import {
  ease,
  spring,
  inView,
...
export default function Skills() {
  ...
  return (
    ...
    >
      {/* Ambient wash — one wide gradient rather than two blurred circles.

          Blurred discs read as discs once the page behind them is lit rather
          than flat black, however large the blur radius is. A radial gradient
          has no edge to find. It is also cheaper: no filter, no extra layer. */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(75%_55%_at_22%_18%,rgba(94,234,212,0.07),transparent_70%),radial-gradient(70%_55%_at_82%_82%,rgba(167,139,250,0.07),transparent_70%)]"
      />
