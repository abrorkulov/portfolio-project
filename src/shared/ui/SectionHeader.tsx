...
import { sectionIndex, type SectionId } from '@/app/sections'
import {
  blurUp,
  ease,
  fadeUp,
...
type SectionHeaderProps = {
  /**
   * Which section this heads. The `01`-style index is looked up from the page
   * registry rather than passed in as a string — that is what stops the
   * numbers drifting out of order when a section is added or moved.
   */
  section: SectionId
  eyebrow: string
  title: string
